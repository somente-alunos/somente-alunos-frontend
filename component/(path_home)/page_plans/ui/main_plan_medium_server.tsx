...
export function Component_MainPlanMediumServer() {
    return (
        <Card className="max-w-96 w-96 outline-offset-1 outline-2 outline outline-[#1adb6e]">
            <CardHeader className="flex flex-col items-start pt-6 px-6">
                <h1 className="flex flex-col text-2xl font-bold">
                    Média Empresa
                </h1>
                <p className='mt-2'>
                    Feito para empresas de médio porte!
                </p>
            </CardHeader>
            <CardBody className="flex flex-col items-center pt-3 pb-6 px-6 overflow-hidden">
                <h2>
                    <span className='text-4xl font-bold'>R$39</span> /mês
                </h2>
