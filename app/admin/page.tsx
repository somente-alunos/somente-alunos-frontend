					...
					<div className="grid gap-4">
						...
						<Component_FormSection title="Conteúdo (POST /post/admin/conteudo)">
							...
							<div className="grid gap-3 md:grid-cols-2">
								...
								<Component_Field label="old_price_content (opcional / null)" value={isCreateContentForm.old_price_content} onChange={(Parameter_value) => setCreateContentForm((Parameter_previous) => ({ ...Parameter_previous, old_price_content: Parameter_value }))} type="number" />
